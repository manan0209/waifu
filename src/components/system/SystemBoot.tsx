...
const biosMessages: BootMessage[] = [
  // BIOS Header
  { text: '', delay: 50, type: 'bios' },
  { text: 'Phoenix BIOS 4.0 Release 6.0', delay: 100, color: '#00ffff', type: 'bios' },
  { text: 'Copyright 1985-2001 Phoenix Technologies Ltd.', delay: 50, color: '#00ffff', type: 'bios' },
  { text: 'WaifuTech P4X266A Rev 1.01', delay: 75, color: '#ffffff', type: 'bios' },
  { text: '', delay: 100, type: 'bios' },
  
  
  { text: 'Memory Test: ', delay: 25, color: '#ffffff', isProgress: true, progressMax: 512, type: 'post' },
  { text: 'Memory: 512MB OK', delay: 100, color: '#00ff00', type: 'post' },
  { text: '', delay: 50, type: 'post' },
  

  { text: 'Detecting IDE Drives...OK', delay: 150, color: '#ffffff', type: 'post' },
  { text: 'Initializing USB...OK', delay: 100, color: '#00ff00', type: 'post' },
  { text: 'Verifying DMI Pool...OK', delay: 100, color: '#00ff00', type: 'post' },
  { text: '', delay: 100, type: 'post' },
  
  
  { text: 'Booting WaifuOS...', delay: 200, color: '#ffffff', type: 'boot' },
  { text: '', delay: 100, type: 'boot' },
  
  
  { text: 'Starting WaifuOS Professional...', delay: 300, color: '#00ffff', type: 'system' },
...
export default function SystemBoot({ onBootComplete }: SystemBootProps) {
  ...
  useEffect(() => {
    if (currentMessageIndex >= biosMessages.length) {
      setTimeout(() => onBootComplete(), 300); // Much faster completion
      return;
    }
    ...
    if (message.isProgress) {
      ...
      const progressInterval = setInterval(() => {
        currentProgress += Math.random() * 80 + 60; 
